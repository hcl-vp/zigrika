setTimeout(() => {
  const UE = require('ue')
  const { PhotographModel } = require('../../Module/Photograph/PhotographModel.js')
  const { SequenceCameraPlayerComponent } = require('../../Camera/SequenceCameraPlayerComponent.js')
  const { FightPhotoController } = require('../../Module/Activity/ActivityContent/FightPhoto/FightPhotoController.js')
  ...
  SequenceCameraPlayerComponent.prototype.lwr = function () {
    ...
    // HEY COMMENT THIS IF YOU WANT REGULAR ULTS AGAIN
