...
pub fn init(player_entity_id: i64, battle_scene_entity_id: i64) PlayerBattleBinder {
    return .{
...
pub fn toProto(comp: PlayerBattleBinder, alloc: mem.Alloc) !pb.PlayerSceneComponentPb {
